<div id="page-wrapper">
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header"><?php echo lang('label_supplier_user_management');?></h1>
		</div>
	</div>
	<!-- search field -->
	<form class="form-horizontal searchForm keep" id="frm" role="form"
		...
		<div class="form-group searchDiv">
			<label class="tableLabel col-lg-2 smallLabel"><?php echo lang('label_supplier_user_id');?></label>
			<div class="col-lg-4">
				<input class="form-control normalInput" type="text" name="EMP_ID"
					id="EMP_ID" value="<?php echo  $info['EMP_ID'];?>">
			</div>
			<label class="tableLabel col-lg-2 normalLabel"><?php echo lang('label_supplier_user_name');?></label>
			<div class="col-lg-4">
