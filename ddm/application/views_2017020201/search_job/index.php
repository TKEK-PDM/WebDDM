...
<div id="page-wrapper">
	...
	<form class="form-horizontal searchForm keep" id="serach_job"
		...
		<div id="collapsingDiv">
			<div class="form-group searchDiv5">
				<label class="tableLabel col-lg-2 smallLabel"><?php echo lang('label_job_no');?></label>
				<div class="col-lg-2 form-inline" style="width: 260px">
					<input class="form-control normalInput" type="text"
						name="job1_code" required="required"
						value="<?php echo $info->job1_code;?>"
						style="display: inline-block; max-width: 200px;"> <input
			...
			<div class="form-group searchDiv5">
				<label class="tableLabel col-lg-2 smallLabel"><?php echo lang('label_me');?></label>
				<div class="col-lg-2" style="width: 260px">
				...
				<label class="tableLabel col-lg-2 smallLabel"><?php echo lang('label_production_class');?></label>
				<div class="col-lg-4">
					<input class="form-control normalInput" type="text" disabled
			...
			<div class="form-group searchDiv5">
				<label class="tableLabel col-lg-2 smallLabel"><?php echo lang('label_job_qty');?></label>
				<div class="col-lg-2" style="width: 260px">
					<input class="form-control normalInput" style="width: 50px;"
						type="text" name="job_qty" disabled
						value="<?php echo $info->job_qty;?>">
				</div>
				<label class="tableLabel col-lg-2 smallLabel"><?php echo lang('label_spec');?></label>
				<div class="col-lg-4">
					<input class="form-control normalInput" type="text" disabled
			...
			<div class="form-group searchDiv5">
				<div class="col-lg-12">
					<label><input type="checkbox" name="level" value="1"
		...
		<div class="form-group searchDiv5">
			<div class="col-lg-12">
				<button class="btn btn-outline btn-blue buttonSpace" type="submit"
					onclick="" id="search"><?php echo lang('button_search');?></button>
				<button class="btn btn-outline btn-blue buttonSpace" type="button"
					onclick="" id="check_file_exist"
				...
				<a href="#" id="send_mail_link"><button
						...
						onclick="" disabled id="send_mail"><?php echo lang('button_send_mail_file_missing');?></button></a>
				<?php endif;?>
			</div>
		</div>
		<!-- search field  end-->
						...
						<table
							...
							<thead>
								<tr>
									...
									<th><?php echo lang('label_download');?></th>
									<?php if($this->session->user_type == 'supplier'):?>
							...
							<tbody>
								...
								<tr class="odd gradeX">
									...
									<td><?php echo $val->DRAW_NO;?></td>
									<td><?php echo $val->PART_CODE;?></td>
									...
									<td>
										...
										<?php echo $val->DWG_NO;?>
										<?php else:?>
										<input class="edit_dwg_no" type="text"
									...
									<td class="align_middle">
											...
											<a href="#"
										onclick="sup_down('<?php echo $val->DWG_NO;?>');return false;"><?php echo lang('label_download')?></a>
											<?php endif;?>
										</td>
									<?php if($this->session->user_type == 'supplier'):?>
	      		...
	      		success: function(msg){
					//set pdf y/n
	          		$.each(msg, function(i,n){
	          			if(n.pdf != ""){
							file_link = '<a href="#" onclick="sup_down(\''+i+'\',\'pdf\');return false;">'+n.pdf+'</a>';
