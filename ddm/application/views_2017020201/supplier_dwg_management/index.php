<div id="page-wrapper">
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header"><?php echo lang('label_supplier_dwg_management');?></h1>
		</div>
	</div>
	<!-- search field -->
	<form class="form-horizontal ng-pristine ng-valid keep" role="form"
							...
							<tbody>
                                ...
                                <tr>
									...
									<th><a href="javascript:void(0);"
										onclick="check_file_exist(<?php echo "'".$val->FILE_NAME."','".$val->SITE_NAME."','".$val->REVISION."','".$val->OBJECT_ID."','".$val->CLASS_ID."','".$val->DWG_NO."')";?>"><?php echo lang('label_download'); ?></a></th>
									<?php if ($val->PDF_YN == 'Y'):?>
										<th><a href="javascript:void(0);"
										onclick="check_file_exist(<?php echo "'".$val->PDF_FILE_NAME."','".$val->SITE_NAME."','".$val->REVISION."','".$val->OBJECT_ID."','".$val->CLASS_ID."','".$val->DWG_NO."')";?>"><?php echo $val->PDF_YN; ?></a></th>
									<?php else:?>
										<th><?php echo $val->PDF_YN; ?></th>
									<?php endif;?>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#checkAll").click(function(){
    		if(this.checked){
    			$(".dwg_sup_info").each(function(){this.checked=true;});
    		}else{
    			$(".dwg_sup_info").each(function(){this.checked=false;});
    		}
    	});
