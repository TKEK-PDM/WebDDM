<div id="page-wrapper">
	<div class="row">
		<div class="col-xs-12">
			<h1 class="page-header"><?php echo lang('label_internal_user_management');?>
		...
		<div id="collapsingDiv" class="form-inline">
			...
			<div class="form-group searchDiv">
				<div class="col-xs-12">
					...
					<select class="form-control normalInput" name="ASSIGNED_VALUE"
						id="ASSIGNED_VALUE">
						...
						<div class="dataTable_wrapper">
							<table
								...
								<tr class="odd gradeX">
										...
										<td class="align_middle"><?php echo $val->USER_DIVISION;?></td>
										<td class="align_middle"><?php echo $val->USER_TITLE;?></td>
										<td class="align_middle"><?php echo $val->LOGIN;?></td>
										<td class="align_middle"><?php echo $val->TDM_DESCRIPTION;?></td>
										<td class="align_middle"><select name="role[]" id="role" onchange=saveAssign(this);
								...
								<?php endforeach;?>
										...
										<td class="align_middle"><?php echo $val->FIRST_NAME;?></td>
										<td class="align_middle"><?php echo $val->LAST_NAME;?></td>
										<td class="align_middle"><?php echo $val->USER_PHONE;?></td>
										<td class="align_middle"><?php echo $val->USER_FAX;?></td>
