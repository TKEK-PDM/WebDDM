<!-- multi select -->
<div class="modal fade" id="cg_mapping" tabindex="-1" role="dialog" style="overflow:;">
	...
	<div class="modal-body" id="modalBody_cg_mapping" style="width:100%">
		<form id="cg_mapping_form" name="cg_mapping_form"
			...
			<div class="row">
				<label class="col-xs-2"><?php echo lang('label_dwg_no');?> </label>
				<input
					type="text" id="search_dwg_no" name="TDM_ID" class="col-xs-3"
					readonly="readonly" /> <label class="col-xs-2"><?php echo lang('label_cg_filter');?></label>
				<input type="text" id="cg_filter" name="cg_filter" class="col-xs-3" />
