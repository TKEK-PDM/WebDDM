        ...
        <form class="searchForm" role="form">
            <div class="row">
                <div class="col-xs-6">
                    ...
                    <button class="btn btn-outline btn-blue buttonSpace" type="button"
                            ...
                            style="margin-left:10px"><?php echo lang('button_check'); ?></button>
                </div>
            </div>
            ...
            <div class="row" style="margin-top: 10px">
                <div class="col-xs-12">
                    ...
                    <button id="close" class="btn btn-outline btn-blue buttonSpace"
                            type="button"><?php echo lang('button_close'); ?></button>
                </div>
            </div>
        </form>
    </div>
