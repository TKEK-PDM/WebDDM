<div id="page-wrapper">
    <div class="row">
        <div class="col-xs-12">
            <h1 class="page-header"><?php echo lang('label_supplier-cg_mapping'); ?>
    ...
    <form class="form-horizontal searchForm keep" id="form" method="post"
		...
		<div id="collapsingDiv" class="form-inline">
			<div class="form-group searchDiv5">
                <div class="col-xs-12">
                    <label class="tableLabel smallLabel"><?php echo lang('label_sup_code'); ?></label>
			...
			<div class="form-group searchDiv5">
                <div class="col-xs-12">
                    <label class="tableLabel smallLabel"><?php echo lang('label_sup_name'); ?></label>
                        ...
                        <form class="form-horizontal searchForm" method="post"
                            ...
                            <table
                                ...
                                <tr>
                                    ...
                                    <th><?php echo lang('label_cg_name'); ?></th>
                                </tr>
                                </thead>
                                <tbody>
                                <?php foreach ($data as $key => $value) { ?>
                                    <tr class="odd gradeX">
                                        ...
                                        <td class="align_middle"><?php echo $value->CG_NAME; ?></td>
                                    </tr>
                                <?php } ?>
...
<div class="modal fade" id="import_excel" tabindex="-1" role="dialog"
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-blue"
                onclick="return submitimport();">import
        </button>
