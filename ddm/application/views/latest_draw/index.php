									...
									<div class="modal-dialog"
										...
										<div class="modal-content">
											...
											<div class="modal-body">
												<div class="row">
													<div class="col-xs-12">
														<div class="col-xs-2"><?php echo lang('label_created_by');?></div>
														<div class="col-xs-2"><?php echo lang('label_create_date');?></div>
														<div class="col-xs-2">Create Time</div>
														<div class="col-xs-2">Modified By</div>
														<div class="col-xs-2">Modified Date</div>
														<div class="col-xs-2">Modified Time</div>
													</div>
												</div>
												<div class="row">
												...
												<div class="row">
													<div class="col-xs-12">
														<div class="col-xs-2"><?php echo $value->CRT_USER; ?></div>
														<div class="col-xs-2"><?php echo $value->CRT_DATE; ?></div>
														<div class="col-xs-2"><?php echo $value->CRT_TIME; ?></div>
														<div class="col-xs-2"><?php echo $value->MOD_USER; ?></div>
														<div class="col-xs-2"><?php echo $value->MOD_DATE; ?></div>
														<div class="col-xs-2"><?php echo $value->MOD_TIME; ?></div>
													</div>
												</div>
											</div>
