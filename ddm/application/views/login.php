...
<?php echo css(css_url('/ict-login.css'))?>
<?php echo css(css_url('/ict-style.css'))?>
</head>
<body>
	<div id="login-wrapper">
		<!--
		<div class="navbar-header" style="width: 100%; background-color: #00a0f5;">
		-->
		<!-- <div class="navbar-header" style="width: 100%; ">
			<a href="#"><img style="height: 100px"
				src="<?php echo base_url();?>public/images/tk_Primary_Logo_RGB_white_72dpi.png">
				<h2><?php echo lang('label_site_title');?></a>
		</div> -->
		<div class="login-container col-lg-4 col-md-6 col-sm-12" style="clear: both">
			<div class="row">
				<div class="login-panel">
					<div class="panel-heading text-left" style="height:unset">							
						<img src="<?php echo base_url();?>public/images/tk_Primary_Logo_RGB_white_72dpi.png">
						<h3><?php echo lang('label_site_title');?></h3>
					...
					<div class="panel-body">
							...
							<div id="loginTable">
								<div class="user_type">
									<!-- <span style="width: 80px"><?php echo lang('label_user_type');?></span> -->
									<input name="user_type" type="radio" value="supplier" id="supplier" <?php if(empty($_COOKIE['user_type']) || $_COOKIE['user_type'] == 'supplier'):?> checked="checked" <?php endif;?>/> 
									<label for="supplier"><?php echo lang('label_supplier');?> </label>
									<input name="user_type" type="radio" value="internal_user" id="internal_user" <?php if($_COOKIE['user_type'] =='internal_user'):?> checked="checked" <?php endif;?>/> 
									<label for="internal_user"><?php echo lang('label_internal_user');?></label>
								</div>
								<div class="login_field">
									<label for=""><?php echo lang('label_user_id');?></label>
									<i class="fa fa-user" aria-hidden="true"></i>
									<input class="form-control" name="username" id="username"
									value="<?php echo set_value('username')?>" type="text" autofocus>
								</div>
								<div class="login_field">
								...
								<div class="language text-right">
									<label for="lang_kor">
										<input name="language" type="radio" value="korean" id="lang_kor" onclick="switchLanguage(this)" <?php if(empty($_COOKIE['language']) || $_COOKIE['language'] == 'korean'):?> checked="checked" <?php endif;?>>
										<span>한국어</span>
									</label>
									<label for="lang_eng">
										<input name="language" type="radio" value="english" id="lang_eng" <?php if($_COOKIE['language'] =='english'):?> checked="checked" <?php endif;?> onclick="switchLanguage(this)">
										<span>English</span>
									</label>
								</div>
							</div>
						...
						<br /> <input type="submit"
							class="btn btn-lg btn-block btn-tke" name="Login"
		...
		<div class="bgi-container col-lg-8 col-md-6 col-sm-12">
			<img src="<?php echo base_url();?>public/images/login-bg.png" alt="">
		</div>
	</div>
	<!-- jQuery -->
